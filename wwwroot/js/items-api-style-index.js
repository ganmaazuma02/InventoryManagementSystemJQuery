...
let gridOptions = {
    columnDefs: [
        ...
        { headerName: "Item Name", field: "itemName", sortable: true },
        { headerName: "Item Description", field: "itemDesc", width: '400px', sortable: true },
...
$('#btnDeleteItem').on('click', function () {
    $.ajax({
        url: '/api/items/delete?itemId=' + $('#deleteItemId').val(),
        type: 'DELETE',
...
$('#btnAddItem').on('click', function () {
    ...
    if ($('#btnAddItem').text() === 'Add Item') {
        ...
        $.ajax({
            url: '/api/items/edit?itemId=' + $('#itemId').val(),
            data: JSON.stringify({
                itemName: itemName,
                itemDesc: itemDesc,
                quantity: parseInt(itemQuantity),
